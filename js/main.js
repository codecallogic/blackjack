            ...
            setTimeout(function () {
                ...
                if (moneyBack > 0) {
                    for (let bets in TABLE.bets) {
                        TABLE.bets[bets].firstElementChild.style.cssText = "display:block;";
                        total.style.cssText = "display:block; color: white; font-size:40px; padding:0 2vmin 0 3vmin;";
                    }
                }
                addOverlay();
            }, 2200)
...
function playerWins() {
    setTimeout(function () {
        ...
        console.log(tableBet);
        moneyBack = tableMoneyDown + tableBet;
        total.innerHTML = tableMoneyDown + tableBet;
        endRound.style.cssText = "color: var(--yellow-gold);";
...
function dealerWins() {
    setTimeout(function () {
        ...
        total.innerHTML = tableMoneyDown;
        tableMoneyDown <= 0 ? total.innerHTML = 0: false;
...
function deal(e) {
    ...
    for (let i = 0; i < 4; i++) {randomCards(); soundPlayer.src = `sounds/drawCard.wav`; soundPlayer.play();}
...
function placeBet(e) {
    soundPlayer.src = `sounds/chip.mp3`;
    soundPlayer.play();
